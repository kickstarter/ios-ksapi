...
public struct ServerConfig: ServerConfigType {
  ...
  public static let production: ServerConfigType = ServerConfig(
    apiBaseUrl: NSURL(string: "https://\(Secrets.Server.Api.production)")!,
    webBaseUrl: NSURL(string: "https://\(Secrets.Server.Web.production)")!,
    apiClientAuth: ClientAuth.production,
    basicHTTPAuth: nil
  )

  public static let staging: ServerConfigType = ServerConfig(
    apiBaseUrl: NSURL(string: "https://\(Secrets.Server.Api.staging)")!,
    webBaseUrl: NSURL(string: "https://\(Secrets.Server.Web.staging)")!,
