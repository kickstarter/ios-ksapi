  ...
  public enum lens {
    public static let backed = Lens<DiscoveryParams, Bool?>(
      ...
      set: { DiscoveryParams(backed: $0, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $1.seed,
    ...
    public static let created = Lens<DiscoveryParams, Bool?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $0, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $1.seed,
        similarTo: $1.similarTo, social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks,
        starred: $1.starred, state: $1.state) }
    )
    public static let hasVideo = Lens<DiscoveryParams, Bool?>(
      view: { $0.hasVideo },
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $0, includePOTD: $1.includePOTD, page: $1.page, perPage: $1.perPage,
        query: $1.query, recommended: $1.recommended, seed: $1.seed, similarTo: $1.similarTo,
        social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred, state: $1.state) }
    )
    public static let includePOTD = Lens<DiscoveryParams, Bool?>(
      view: { $0.includePOTD },
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $0, page: $1.page, perPage: $1.perPage,
        query: $1.query, recommended: $1.recommended, seed: $1.seed, similarTo: $1.similarTo,
        social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred, state: $1.state) }
    )
    public static let page = Lens<DiscoveryParams, Int?>(
      view: { $0.page },
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $0,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $1.seed,
        similarTo: $1.similarTo, social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks,
        starred: $1.starred, state: $1.state) }
    )
    public static let perPage = Lens<DiscoveryParams, Int?>(
      view: { $0.perPage },
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page, perPage: $0,
        query: $1.query, recommended: $1.recommended, seed: $1.seed, similarTo: $1.similarTo,
        social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred, state: $1.state) }
    )
    public static let query = Lens<DiscoveryParams, String?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $0, recommended: $1.recommended, seed: $1.seed, similarTo: $1.similarTo,
        social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred, state: $1.state) }
    )
    public static let recommended = Lens<DiscoveryParams, Bool?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $0, seed: $1.seed, similarTo: $1.similarTo,
        social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred, state: $1.state) }
    )
    public static let seed = Lens<DiscoveryParams, Int?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $0, similarTo: $1.similarTo,
        social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred, state: $1.state) }
    )
    public static let similarTo = Lens<DiscoveryParams, Project?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $1.seed, similarTo: $0,
        social: $1.social, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred, state: $1.state) }
    )
    public static let social = Lens<DiscoveryParams, Bool?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $1.seed,
        similarTo: $1.similarTo, social: $0, sort: $1.sort, staffPicks: $1.staffPicks, starred: $1.starred,
        state: $1.state) }
    )
    public static let sort = Lens<DiscoveryParams, DiscoveryParams.Sort?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $1.seed,
        similarTo: $1.similarTo, social: $1.social, sort: $0, staffPicks: $1.staffPicks, starred: $1.starred,
        state: $1.state) }
    )
    public static let staffPicks = Lens<DiscoveryParams, Bool?>(
      ...
      set: { DiscoveryParams(backed: $1.backed, category: $1.category, collaborated: $1.collaborated,
        created: $1.created, hasVideo: $1.hasVideo, includePOTD: $1.includePOTD, page: $1.page,
        perPage: $1.perPage, query: $1.query, recommended: $1.recommended, seed: $1.seed,
        similarTo: $1.similarTo, social: $1.social, sort: $1.sort, staffPicks: $0, starred: $1.starred,
        state: $1.state) }
    )
