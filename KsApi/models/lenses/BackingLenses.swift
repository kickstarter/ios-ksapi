...
extension Backing {
  public enum lens {
    public static let amount = Lens<Backing, Int>(
      view: { $0.amount },
      set: { Backing(amount: $0, backerId: $1.backerId, id: $1.id, locationId: $1.locationId,
    ...
    public static let backerId = Lens<Backing, Int>(
      view: { $0.backerId },
      set: { Backing(amount: $1.amount, backerId: $0, id: $1.id, locationId: $1.locationId,
        pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry, projectId: $1.projectId,
        reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence, shippingAmount: $1.shippingAmount,
        status: $1.status) }
    )
    ...
    public static let locationId = Lens<Backing, Int?>(
      view: { $0.locationId },
      set: { Backing(amount: $1.amount, backerId: $1.backerId, id: $1.id, locationId: $0,
        pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry, projectId: $1.projectId,
        reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence, shippingAmount: $1.shippingAmount,
        status: $1.status) }
    )
    ...
    public static let pledgedAt = Lens<Backing, NSTimeInterval>(
      ...
      set: { Backing(amount: $1.amount, backerId: $1.backerId, id: $1.id, locationId: $1.locationId,
        pledgedAt: $0, projectCountry: $1.projectCountry, projectId: $1.projectId,
        reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence, shippingAmount: $1.shippingAmount,
        status: $1.status) }
    )
    ...
    public static let projectCountry = Lens<Backing, String>(
      ...
      set: { Backing(amount: $1.amount, backerId: $1.backerId, id: $1.id, locationId: $1.locationId,
        pledgedAt: $1.pledgedAt, projectCountry: $0, projectId: $1.projectId,
        reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence, shippingAmount: $1.shippingAmount,
        status: $1.status) }
    )
    ...
    public static let projectId = Lens<Backing, Int>(
      view: { $0.projectId },
      set: { Backing(amount: $1.amount, backerId: $1.backerId, id: $1.id, locationId: $1.locationId,
        pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry, projectId: $0,
        reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence, shippingAmount: $1.shippingAmount,
        status: $1.status) }
    )
